...
## Now（当前焦点 · 2026-06-09）
「家庭 + 用户」多租户改造三轮 + 个人中心已全部落地并真机验证（ADR-008/009）：隔离键 openid → family，每云函数 assertMember 守卫；个人中心（个人档案昵称头像 / 家庭切换·管理·邀请码 / 用户·隐私协议）。全代码库经对抗式评审，修掉 user `_openid` 隔离键漏写等一批真问题。当前 8 云函数 + 9 集合，版本 0.2.0。
