...
| SPEC | ✅ | 数据字典（9 集合 + foods 占位：字段 / 类型 / 隔离键）；对外 API = N/A（消费方非被集成方）|
...
| DECISIONS | ✅ | ADR-001~005 + 006 提醒先站内 + 007 UI 令牌 + 008 家庭多租户/隔离键 + 009 个人中心/users + 010 导航重构 + 011 附件/限额 + 012 字段(医院/费用/病程) + 013 数据模型定型 |
